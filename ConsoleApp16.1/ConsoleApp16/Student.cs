...
{
    static class StudentAdder 
    {
        public delegate void MethodHandler();


        public static event MethodHandler PAddStudent;
        public static event MethodHandler PDelStudent;
        public static event MethodHandler PShowStudent;
        public static event MethodHandler PStopStudent;
      
        public static void StartStudentG(this Group s)
        {
            PAddStudent();
            PDelStudent();
            PShowStudent();
